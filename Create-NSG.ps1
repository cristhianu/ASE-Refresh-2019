...
# Inbound Rules
$ir1 = New-AzureAzNetworkSecurityRuleConfig -Name "Inbound-management" -Description "Used to manage ASE from public VIP" `
...
$ir2 = New-AzureAzNetworkSecurityRuleConfig -Name "Inbound-load-balancer-port" -Description "ASE-internal-inbound" `
...
$ir3 = New-AzureAzNetworkSecurityRuleConfig -Name "ASE-internal-inbound" -Description "ASE-internal-inbound" `
...
$ir4 = New-AzureAzNetworkSecurityRuleConfig -Name "Inbound-FTP" -Description "Allow FTP over port 21" `
...
$ir5 = New-AzureAzNetworkSecurityRuleConfig -Name "Inbound-FTPs" -Description "Allow FTPS" `
...
$ir6 = New-AzureAzNetworkSecurityRuleConfig -Name "Inbound-FTP-Data" -Description "Allow FTP Data" `
...
$ir7 = New-AzureAzNetworkSecurityRuleConfig -Name "Inbound-Remote-Debugging" -Description "Visual Studio remote debugging" `
...
# Outbound Rules
$or1 = New-AzureAzNetworkSecurityRuleConfig -Name "Outbound-80-443" -Description "HTTP/HTTPS" `
...
$or2 = New-AzureAzNetworkSecurityRuleConfig -Name "Time-NTP" -Description "Azure Storage queue" `
...
$or3 = New-AzureAzNetworkSecurityRuleConfig -Name "Outbound-DB" -Description "Database" `
...
$or4 = New-AzureAzNetworkSecurityRuleConfig -Name "Outbound-Monitor" -Description "Monitoring" `
...
$or5 = New-AzureAzNetworkSecurityRuleConfig -Name "ASE-internal-outbound" -Description "Azure Internal Outbound" `
...
$or6 = New-AzureAzNetworkSecurityRuleConfig -Name "Internet-Outbound" -Description "Internet Outbound" `
